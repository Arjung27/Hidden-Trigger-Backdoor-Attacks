...
#SBATCH --job-name=res_9                            # sets the job name if not set from environment
...
CUDA_VISIBLE_DEVICES=0 python generate_poison.py cfg_CIFAR/singlesource_singletarget_binary_finetune_2/experiment_0019.cfg &&
CUDA_VISIBLE_DEVICES=0 python finetune_and_test.py cfg_CIFAR/singlesource_singletarget_binary_finetune_2/experiment_0019.cfg