...
#SBATCH --job-name=desmob20                            # sets the job name if not set from environment
...
python generate_poison.py cfg_ImageNet/random_crop/singlesource_singletarget_binary_finetune_9/experiment_0020.cfg &&
python finetune_and_test.py cfg_ImageNet/random_crop/singlesource_singletarget_binary_finetune_9/experiment_0020.cfg