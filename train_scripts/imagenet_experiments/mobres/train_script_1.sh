...
#SBATCH --job-name=mobres11                            # sets the job name if not set from environment
...
python generate_poison.py cfg_ImageNet/random_crop/singlesource_singletarget_binary_finetune_8/experiment_0011.cfg &&
python finetune_and_test.py cfg_ImageNet/random_crop/singlesource_singletarget_binary_finetune_8/experiment_0011.cfg