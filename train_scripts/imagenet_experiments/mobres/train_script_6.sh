...
#SBATCH --job-name=mobres16                            # sets the job name if not set from environment
...
python generate_poison.py cfg_ImageNet/random_crop/singlesource_singletarget_binary_finetune_8/experiment_0016.cfg &&
python finetune_and_test.py cfg_ImageNet/random_crop/singlesource_singletarget_binary_finetune_8/experiment_0016.cfg