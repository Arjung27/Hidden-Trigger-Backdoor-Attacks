...
python generate_poison.py cfg_ImageNet/random_crop/singlesource_singletarget_binary_finetune_3/experiment_0013.cfg &&
python finetune_and_test.py cfg_ImageNet/random_crop/singlesource_singletarget_binary_finetune_3/experiment_0013.cfg