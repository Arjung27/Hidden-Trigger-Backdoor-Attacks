...
python generate_poison.py cfg_CIFAR/singlesource_singletarget_binary_finetune_5/experiment_0012.cfg &&
python finetune_and_test.py cfg_CIFAR/singlesource_singletarget_binary_finetune_5/experiment_0012.cfg