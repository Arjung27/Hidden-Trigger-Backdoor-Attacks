...
#SBATCH --job-name=dense19                            # sets the job name if not set from environment
...
python generate_poison.py cfg_CIFAR/singlesource_singletarget_binary_finetune_4/experiment_0019.cfg &&
python finetune_and_test.py cfg_CIFAR/singlesource_singletarget_binary_finetune_4/experiment_0019.cfg