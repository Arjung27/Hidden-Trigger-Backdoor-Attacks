...
#SBATCH --job-name=1000cls9                            # sets the job name if not set from environment
...
CUDA_VISIBLE_DEVICES=0 python generate_poison.py cfg_ImageNet/singlesource_singletarget_1000class_finetune/experiment_0009.cfg &&
CUDA_VISIBLE_DEVICES=0 python finetune_and_test.py cfg_ImageNet/singlesource_singletarget_1000class_finetune/experiment_0009.cfg