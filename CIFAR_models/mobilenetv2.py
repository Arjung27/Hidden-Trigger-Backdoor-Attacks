...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes=10, train_dp=0, test_dp=0, droplayer=0, bdp=0, poison=False):
...
def mobilenet_v2(train_dp=0, test_dp=0, droplayer=0, bdp=0, pretrained=True, poison=False, **kwargs):

    model =  MobileNetV2(train_dp=train_dp, test_dp=test_dp, droplayer=droplayer, \
                    bdp=bdp, poison=poison)

    if pretrained:
        model_file_name = '/nfshomes/arjgpt27/Experiments/Hidden-Trigger-Backdoor-Attacks_cifar/checkpoints/MobileNetV2_seed_1000_normalize=True_augment=False_optimizer=SGD_epoch=199.t7'
